...
double voltage_V2_array[50] = {0}; // variable to store the value read
double voltage_V1_array[50] = {0};
double current_I2_array[50] = {0};
double current_I1_array[50] = {0};
...
volatile double FirstWheelStart;
volatile double timer1stWheel;
	...
	if (carDetectedTrigger)
	{
		...
		{			
			...
			if (count == 50)
			{
				...
				energy_I = (double)power_I * timer1stWheel / 10000;
				energy_II = (double)power_II * timer1stWheel / 10000;
